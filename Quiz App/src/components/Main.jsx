...
export default function Main() {
  return (
    <div className="relative m-4 mt-7 xs:m-5">
      <div className="absolute top-6 left-[10%] w-[80%] h-full bg-[#9f61f7] rounded-3xl z-10"></div>
      <div className="absolute top-3 left-[5%] w-[90%] h-full bg-[#c99bfe] rounded-3xl z-20"></div>
